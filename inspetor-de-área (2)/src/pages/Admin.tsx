...
import { PlusCircle, ClipboardList, BarChart3, Download, RotateCcw, User, X, AlertCircle } from 'lucide-react';
      ...
      <div className="bg-white rounded-3xl p-6 shadow-md border border-black/5 space-y-6">
        {!supabaseConnected && (
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-amber-800">Supabase não configurado</p>
              <p className="text-[10px] text-amber-700 mt-1">O aplicativo está usando armazenamento local. Configure as variáveis de ambiente VITE_SUPABASE_URL e VITE_SUPABASE_ANON_KEY para habilitar o banco de dados remoto.</p>
            </div>
          </div>
        )}
